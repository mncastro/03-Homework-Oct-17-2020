// I used the solution provided in this repository. I tried rewriting the code with IF statements (instead of while) and objects instead of separate arrays, but I couldn't make it work.
// Credit goes to Tiffany Casey https://github.com/TiffanyCasey/Password-Generator
...
function generatePassword() {
  ...
  // Loop if answer is outside the parameters 
    while(answerLength <= 8 || answerLength >= 128) {
    ...
    // Loop if prompts do not include at least one criteria 
      while (answerUpperCase === false && answerLowerCase === false && answerSpecialChara === false && answerNumbers === false) {
